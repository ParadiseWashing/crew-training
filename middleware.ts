...
// Decode the next-auth JWT from cookie without importing next-auth (which pulls in Node-only modules)
async function getTokenPayload(req: NextRequest): Promise<Record<string, unknown> | null> {
